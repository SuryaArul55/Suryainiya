...
import com.pomanager.PomAutom;

public class Testngauto extends Baseclass {
	...
	@BeforeMethod
	private void sigin() throws Throwable {
	...
	private void Signout() {
		clickonElement(pom.get_Instance_Login().getLoginout());
	...
	private void Womendress() throws Throwable {
	 ...
	 @Test(priority=1)
	 private void Thirdorder() throws Throwable {
